...
Description: limupa - Digital Products Store MVC_Project Bootstrap 4 Template;
Template URI:;
Author Name:HasTech;
Author URI:;
Version: 1;
...
/*----------------------------------------*/
	...
	$('.category-heading').on('click', function(){
	    $('.category-menu-list').slideToggle(300); // not involved
	});	
	/*-- Category Menu Toggles --*/
	function categorySubMenuToggle() {
	    var screenSize = $(window).width();
<<<<<<< Updated upstream:MVC-Project/wwwroot/js/main.js
	    if ( screenSize <= 100/*991*/) {
=======
	    if ( screenSize <= 991) {
>>>>>>> Stashed changes:MVC-Project/MVC-Project/wwwroot/js/main.js
